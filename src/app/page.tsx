...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative pt-20 pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="absolute inset-0 bg-linear-to-b from-[#FDFCF8] to-[#F3EFE4] -z-10 rounded-b-[4rem]"></div>
        
        <div className="flex-1 space-y-8 z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm border border-[#EAE6D9]">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold leading-[1.1] text-[#2C352D] font-playfair tracking-tight">
            Lebih Sehat,<br />
            Lebih Mudah <span className="text-[#D4A373] italic">Dicerna.</span>
          </h1>
          
          <p className="text-lg text-[#5A665A] leading-relaxed max-w-xl font-light">
        ...
        <div className="flex-1 relative w-full aspect-square max-w-md mx-auto">
          ...
          <div className="relative h-full w-full bg-white rounded-[2.5rem] shadow-xl border border-white/50 flex flex-col items-center justify-center p-8 rotate-3 hover:rotate-0 transition-transform duration-500">
      ...
      <section id="edukasi" className="py-24 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="bg-white p-10 rounded-3xl shadow-sm border border-[#EAE6D9]/50 hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
      ...
      <section className="py-24 bg-[#F3EFE4]/40 border-y border-[#EAE6D9]/50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-[#EAE6D9]/50 group hover:shadow-xl transition-all duration-300">
            ...
            <div className="bg-[#3A5034] p-10 rounded-[2rem] shadow-lg text-white flex flex-col justify-center relative overflow-hidden">
      ...
      <section id="affiliate" className="py-24 px-4 max-w-7xl mx-auto">
        <div className="bg-gradient-to-br from-[#2C352D] to-[#3A5034] rounded-[3rem] p-8 md:p-16 text-white shadow-2xl relative overflow-hidden">
